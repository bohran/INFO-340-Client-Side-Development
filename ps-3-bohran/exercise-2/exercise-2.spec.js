...
describe('getLetterFrequencies() function', () => {
    test('produces expected output', () => {
        expect(solution.getLetterFrequencies("mississippi")).toEqual({
            m: 1,
            i: 4,
            s: 4,
            p: 2
        });
        expect(solution.getLetterFrequencies("she sells sea shells down by the sea shore")).toEqual({
            h: 4,
            e: 7,
            ' ': 8,
            l: 4,
...
describe('Deck variable of "cards"', () => {
    test('contains expected cards', () => {
        expect(solution.deck).toContainEqual({
            rank: 14,
            suit: 'spades'
        }); //AS    
        expect(solution.deck).toContainEqual({
        ...
        expect(solution.deck).not.toContainEqual({
            rank: 1,
            suit: 'spades'
        }); //! 1S
        expect(solution.deck).not.toContainEqual({
...
describe('Searching functions', () => {
    ...
    describe('getHighCard() function', () => {
        test('produces expected output', () => {
            ...
            expect(solution.getHighCard(hand)).toEqual({
                rank: 14,
                suit: 'spades'
            });
        })
